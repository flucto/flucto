...
{
    /// <summary>
    /// Marks a method as the (potentially asynchronous) initialization method of a <see cref="flucto.Graphics.Drawable"/>, allowing for automatic injection of dependencies via the parameters of the method.
    /// </summary>
    [MeansImplicitUse]
