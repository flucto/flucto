...
using flucto.Audio.Track;
using flucto.Graphics.Batches;
using flucto.Graphics.OpenGL.Vertices;
using flucto.Graphics.Primitives;
using flucto.Graphics.Shaders;
...
using RectangleF = flucto.Graphics.Primitives.RectangleF;

namespace flucto.Graphics.Audio
{
    /// <summary>
