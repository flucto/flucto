...
using osuTK;
using osuTK.Input;
using JoystickState = flucto.Input.States.JoystickState;
using KeyboardState = flucto.Input.States.KeyboardState;
using MouseState = flucto.Input.States.MouseState;
